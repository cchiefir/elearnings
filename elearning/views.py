...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if kwargs.get('id'):
            print(kwargs.get('id'))
            self.obj = get_object_or_404(self.model, id=kwargs.get('id'), owner = request.user)
        return super().dispatch(request, *args, **kwargs)
    ...
    def post(self, request, module_id, model_name, id=None):
        ...
        if form.is_valid():
            ...
            if not id:
                ...
                return redirect('elearning:module_content_list', self.module.id)
            return self.render_to_response({'form': form, 'object': self.obj})


# View to DELETE content from Courses
class ContentDeleteView(View):
    ...
    def post(self, request, id):
        ...
        content.item.delete()
        content.delete()
        return redirect('elearning:module_content_list', module.id)


# View SHOW list of Modules
...
#View to REORDER Modules on Edit Module page
...
#View to REORDER Content of Modules on Edit Module page
